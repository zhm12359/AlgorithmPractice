...
public class SuffixTree
{
    ...
    public static void main(String[] args)
    {
        ...
        SuffixTree st = new SuffixTree("abbbbba$cabbb%");

        System.out.println(dfs(st.getRoot(), "abbbbba", "cabbb" ).toString());

    }


    public static Node dfs(Node root, String x, String y){
        ...
        while(it.hasNext()){
            ...
            if(x.contains(child.toString()) && y.contains(child.toString()) ){
                Node dfsChild = dfs(child, x, y);
